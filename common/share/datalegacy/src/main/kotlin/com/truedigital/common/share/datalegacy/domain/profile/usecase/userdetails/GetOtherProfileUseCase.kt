...
interface GetOtherProfileUseCase {
    fun execute(ssoid: String, fields: String? = null): Flow<ResultResponse<ProfileModel>>
}

class GetOtherProfileUseCaseImpl @Inject constructor(
    private val profileRepository: ProfileRepository,
    private val localizationRepository: LocalizationRepository
) : GetOtherProfileUseCase {

    override fun execute(ssoid: String, fields: String?): Flow<ResultResponse<ProfileModel>> {
        return profileRepository.getOtherProfile(
            ssoid,
            fields,
