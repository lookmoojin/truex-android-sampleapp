...
class MusicTrendingItemListGhostLoadingView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ConstraintLayout(context, attrs, defStyleAttr) {

    private var binding: ViewGhostLoadingItemListBinding =
        ViewGhostLoadingItemListBinding.inflate(LayoutInflater.from(context))
