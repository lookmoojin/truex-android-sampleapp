...
import com.truedigital.features.music.api.interceptor.MusicInterceptor
...
@Module
object MusicLandingModule {

    @Provides
    @Singleton
    fun providesMusicLandingApiInterface(
    ...
    ): MusicLandingApiInterface {
        return ApiGsonBuilder(
            okHttpClient.addInterceptor(MusicInterceptor()),
