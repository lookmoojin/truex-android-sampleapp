...
class UploadListViewHolder(
    ...
    fun bind(task: TrueCloudFilesModel.Upload) {
        binding.apply {
            ...
            trueCloudPauseImageView.setOnClickListener { onActionClick.onPauseClicked(task) }
            trueCloudRetryImageView.setOnClickListener { onActionClick.onRetryClicked(task) }
            trueCloudCancelImageView.setOnClickListener { onActionClick.onCancelClicked(task) }
        }
    }
}
