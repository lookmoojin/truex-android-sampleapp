...
class UploadGridViewHolder(
    ...
    fun bind(file: TrueCloudFilesModel.Upload) {
        binding.apply {
            ...
            trueCloudPauseImageView.setOnClickListener {
                onActionClick.onPauseClicked(file)
            }
            trueCloudRetryImageView.setOnClickListener {
                onActionClick.onRetryClicked(file)
            }
            trueCloudCancelImageView.setOnClickListener {
                onActionClick.onCancelClicked(file)
            }
        }
    }
